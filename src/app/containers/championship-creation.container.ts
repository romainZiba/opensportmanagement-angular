...
export class ChampionshipCreationSmartComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  createChampionship(championship: ChampionshipForm) {
    this.teamService.createChampionship(championship, this.seasonId).then(success => {
      if (success) {
