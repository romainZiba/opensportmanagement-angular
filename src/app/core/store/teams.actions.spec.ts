...
describe("Teams Actions", () => {
  ...
  describe("Load Teams Success", () => {
    it("should create an action", () => {
      ...
      team.name = "team";
      const teams = [team];
      expect(fromTeam.LoadTeamsSuccess.type).toBe(
        fromTeam.TeamActionsType.LOAD_TEAMS_SUCCESS
      );
  ...
  describe("Load Teams Failed", () => {
    it("should create an action", () => {
      const error = "error";
      expect(fromTeam.LoadTeamsFailed.type).toBe(
        fromTeam.TeamActionsType.LOAD_TEAMS_FAILED
      );
  ...
  describe("Select Team", () => {
    it("should create an action", () => {
      const id = 1;
      expect(fromTeam.SelectTeam.type).toBe(
        fromTeam.TeamActionsType.SELECT_TEAM
      );
